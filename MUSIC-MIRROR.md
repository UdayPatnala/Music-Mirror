...
| `2.06.04.0` | FUNCTIONAL | `ebfab56` | 2026-09-21 | Spotify secondary metadata provider, cross-provider matching, and identity resolution. |
| `2.06.04.1` | PATCH | `d4477a2` | 2026-09-21 | Camera stream lifecycle reuse, background model preloading, and player bootstrap. |
