...
from app.api.routes import recommendations, health, telemetry, local_explorer, songs, user_preferences, reports, spotify
...
app.include_router(spotify.router, prefix="/api/v2/spotify", tags=["Spotify Secondary Provider"])
